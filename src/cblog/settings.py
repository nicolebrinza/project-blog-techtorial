...
DATABASES = {
    'default': {
        ...
        'NAME': 'MyDatabase', # database name in RDS is written here
        'USER': 'admin', # database master username in RDS is written here
        'PASSWORD': config('PASSWORD'),
        'HOST': 'mydatabase.cyeykphrvyoy.us-east-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'nicoleta-website' # please enter your s3 bucket name
